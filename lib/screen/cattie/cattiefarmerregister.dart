...
class FarmerListCattle extends StatefulWidget {

  // void _launchURL(String url) async =>
  //     await canLaunch(url) ? await launch(url) : throw 'Could not launch $url';
  @override
  State<FarmerListCattle> createState() => _FarmerListCattleState();
}

class _FarmerListCattleState extends State<FarmerListCattle> {
                      ...
                      itemBuilder: (context,index){
                        return InkWell(
                          onTap: ()async{
                            ...
                            Get.to(() => Cattie(id:responseFarmer.data[index].id),transition: Transition.rightToLeftWithFade,duration: const Duration(milliseconds: 600));
                          },
                          child: Container(
